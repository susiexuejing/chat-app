...
test('scope manifest preserves exact legacy and bounded structural profile boundaries', async () => {
  ...
  assert.deepEqual(manifest.approvedProfiles, [
    ...
    },
    {
      ...
      ticketId: 'EF-107',
      candidateSha: '259a9bb8e2d60cbce2f30235ce288badb39b673a',
      candidateParentSha: '59f70e9d7b47de238e1e0564c3ce42d2912d8b5b',
      candidatePatchId: '5dbdf01ab6391ab9dff6b564ea3f37545b21a766',
