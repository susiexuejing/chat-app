...
const ANALYTICAL_WORDS = [
  ...
  '大概率', '大概率是', '可能性', '判断', '衡量',
  '对比', '标准', '结论', '推理', '论证',
  // ─── 增强：分析模式（analysis_to_feeling 前置检测）───
  '道理我懂', '我知道', '我明白', '我理解',
  '道理明白', '理性上', '理论上', '道理上',
  '想通了', '想明白', '我知道应该', '我懂',
];
...
const FEELING_WORDS = [
  ...
  '不舒服', '不好受', '揪心', '窒息', '发麻',
  '身体', '呼吸', '心跳', '眼泪', '哭',
  // ─── 增强：身体感受（analysis_to_feeling 专用）───
  '心堵', '心里堵', '胃里沉', '身体紧', '发紧',
  '心沉', '心里沉', '胃里堵', '胸口堵',
];
...
const INTERNAL_ATTRIBUTION_WORDS = [
  ...
  // ─── 增强：短消息自责（精确匹配以下片段即可）───
  '都怪我', '一定是我', '可能是我', '会不会是我',
  '是不是我的问题', '我做错了什么', '说错话', '是我的问题',
  '我说错了', '我搞砸了', '我没用', '我真没用',
  // ─── 进一步增强：短语粒度自责令牌 ───
  '是不是我说错', '是不是我做错', '是我的错',
  '说错了什么', '做错了什么', '我说错', '我做错',
  '怪我自己', '都怨我', '怨我', '我不好',
  // ─── self_blame 增强：自己开头的自责 ───
  '自己不好', '自己不行', '自己不对', '觉得自己不好',
  '觉得自己不行', '觉得自己不对', '觉得自己能力',
  '认为自己不好', '认为自己不行',
];
...
const HELPLESSNESS_WORDS = [
  ...
  '白费', '白费力气', '徒劳', '做什么都没用',
  '没戏', '不行了', '完蛋', '没救',
  // ─── control_to_helplessness 增强 ───
  '改变不了什么', '什么都改变不了', '什么都做不了',
  '怎么都没用', '试了也没用', '试什么都没用',
  '不管用', '怎么试都没用', '一点办法没有',
  '我没办法', '我改变不了', '我放弃了',
];
